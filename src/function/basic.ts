...
export const logMessage6: LogMessage = (message) => console.log('Function basic sample 6:', message)

type FullLogMessage = {
  (message: string): void
}
export const logMessage7: FullLogMessage = (message) => console.log('Function basic sample 7:', message)
